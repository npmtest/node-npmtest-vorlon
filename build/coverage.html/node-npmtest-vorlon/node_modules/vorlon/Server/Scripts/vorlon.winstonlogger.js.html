...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-vorlon/node_modules/vorlon/Server/Scripts/vorlon.winstonlogger.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-vorlon/node_modules/vorlon/Server/Scripts/vorlon.winstonlogger.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-vorlon/node_modules/vorlon/Server/Scripts/</a> &#187; vorlon.winstonlogger.js</div>
</div>
<div class="body">
...
(function (VORLON) {
    var WinstonLogger = (function () {
        function WinstonLogger(context) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this.logConfig.enableConsole) {
