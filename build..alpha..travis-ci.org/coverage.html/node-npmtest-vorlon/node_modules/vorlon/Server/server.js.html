...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-vorlon/node_modules/vorlon/Server/server.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-vorlon/node_modules/vorlon/Server/server.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-vorlon/node_modules/vorlon/Server/</a> &#187; server.js</div>
</div>
<div class="body">
...
<span class="missing-if-branch" title="else path not taken" >E</span>if (!context.httpConfig.proxyEnvPort) {
...
<span class="cstat-no" title="statement not covered" >    var serverProxy = new vorlonHttpProxy.VORLON.HttpProxy(context, true);</span>
<span class="cstat-no" title="statement not covered" >    serverProxy.start();</span>
}
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
